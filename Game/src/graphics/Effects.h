...
public:
	...
	void playerWalkEffect(glm::vec3& location);
	void teslaAttackEffect(glm::vec3& location);
	void killEffect(glm::vec3& location, int model_id);
	void resourceEffect(glm::vec3& location, int model_id);
	void particleEffect(glm::vec3& location, int model_id);
	void martianEffect(glm::vec3& location, int model_id);
	void bossEffect(glm::vec3& location, int model_id);
};