...
void GameWorld::init() {
	...
	models[MODEL_ID_TOWER_TESLA] = new ObjectModel("../assets/tesla/tower_tesla.obj");
	...
	shaders[MODEL_ID_TOWER_TESLA] = new Shader("../shaders/model_loading.vert", "../shaders/model_loading.frag");
